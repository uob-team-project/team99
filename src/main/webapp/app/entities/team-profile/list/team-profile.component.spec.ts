...
import { sampleWithRequiredData } from '../team-profile.test-samples';
...
describe('TeamProfile Management Component', () => {
  let comp: TeamProfileComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(TeamProfileComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.teamProfiles?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to teamProfileService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTeamProfileIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTeamProfileIdentifier).toHaveBeenCalledWith(entity);

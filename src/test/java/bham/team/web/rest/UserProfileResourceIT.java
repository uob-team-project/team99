...
class UserProfileResourceIT {
    ...
    private static final String DEFAULT_UOB_USERNAME = "AAAAAAAAAA";
    private static final String UPDATED_UOB_USERNAME = "BBBBBBBBBB";
    ...
    public static UserProfile createEntity() {
        return new UserProfile()
            .uobUsername(DEFAULT_UOB_USERNAME)
    ...
    public static UserProfile createUpdatedEntity() {
        return new UserProfile()
            .uobUsername(UPDATED_UOB_USERNAME)
    ...
    void getAllUserProfiles() throws Exception {
        ...
        restUserProfileMockMvc
            ...
            .andExpect(jsonPath("$.[*].uobUsername").value(hasItem(DEFAULT_UOB_USERNAME)))
    ...
    void getUserProfile() throws Exception {
        ...
        restUserProfileMockMvc
            ...
            .andExpect(jsonPath("$.uobUsername").value(DEFAULT_UOB_USERNAME))
    ...
    void partialUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.uobUsername(UPDATED_UOB_USERNAME);
